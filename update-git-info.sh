...
# This script generates git information for the latest commit in the repository
...
git --no-pager log -1 --date=iso8601 --pretty=format:'{"commit": "%H", "short_commit": "%h", "date": "%ai", "author": "%an", "subject": "%s"}' > data/git_info.json
